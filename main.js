...
var AppComponent = /** @class */ (function () {
    function AppComponent() {
        this.posts = [
            new Post('Mon Premier poste', 'Le temps va te voler des amis, des amis qui vont t\'oublier, qui vont peut-être tellement changer que tu auras l\'impression de ne plus les connaître. Le temps va te voler des souvenirs, qui petit à petit, s\'échapperont de ta mémoire et deviendront de plus en plus flous'),
            new Post('Mon deuxieme poste', 'En effet, la plupart des blogueurs passent énormément de temps à produire leur contenu, car rédiger un bon article, qui sera lu, commenté et partagé demande du temps et de la réflexion.'),
            new Post('Mon troisieme poste', 'Les internautes veulent avoir les informations rapidement lorsqu\'ils consultent un blog. Vous devez donc leur permettre de visualiser les renseignements, grâce à des titres et sous-titres optimisés. Une structure pertinente, avec les bons mots-clés, offre un certain confort de lecture à vos visiteurs et aide les moteurs de recherche à mieux vous positionner par rapport aux requêtes des internautes.'),
        ];
    }
...
module.exports = "<li  [ngClass]=\"{'list-group-item':true,\n 'list-group-item-success':isLoved(),\n  'list-group-item-danger':isUnLoved()}\">\n\n  <h4 [ngStyle]=\"{color:getColor()}\">{{title}} </h4>\n  <h6 [ngStyle]=\"{color:getColor()}\" style=\"align-content: left\">{{created_at | date:'short'}} </h6>\n  <p [ngStyle]=\"{color:getColor()}\">{{content}}</p>\n<button class=\"btn btn-success\" (click)=\"onLoveIt()\" >Love it</button>\n  <button class=\"btn btn-danger\" (click)=\"onDontLoveIt()\" >Dont Love it</button>\n</li>\n"
...
var PostListComponent = /** @class */ (function () {
    ...
    PostListComponent.prototype.onLoveIt = function () {
        this.loveIts++;
    };
    PostListComponent.prototype.onDontLoveIt = function () {
        this.loveIts--;
    };
    PostListComponent.prototype.isLoved = function () {
        return this.loveIts > 0;
    };
    PostListComponent.prototype.isUnLoved = function () {
        return this.loveIts < 0;
    };
    PostListComponent.prototype.getColor = function () {
        if (this.isLoved())
            return 'green';
        else if (this.isUnLoved())
            return 'red';
        else
            return 'black';
    };
...
module.exports = __webpack_require__(/*! D:\workSpace\angular\blogApp\src\main.ts */"./src/main.ts");
